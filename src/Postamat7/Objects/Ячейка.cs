...
namespace IIS.Postamat7
{
    ...
    [View("ЯчейкаE", new string[] {
            ...
            "Хранение.ДатаНачала as \'нач\'",
            "Хранение.ДатаЗавершения as \'зав\'",
            "Хранение.Продление as \'про\'"}, Hidden=new string[] {
            "Хранение.Номер",
            "Хранение.ДатаНачала",
    ...
    public class Ячейка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat7.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat7.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat7.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat7.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЯчейкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаE", typeof(IIS.Postamat7.Ячейка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЯчейка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat7.DetailArrayOfЯчейка members)

        // *** End programmer edit section *** (IIS.Postamat7.DetailArrayOfЯчейка members)
        ...
        /// </summary>
        public DetailArrayOfЯчейка(IIS.Postamat7.Постамат fПостамат) : 
                base(typeof(Ячейка), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat7.Ячейка this[int index]
        {
            get
            {
                return ((IIS.Postamat7.Ячейка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat7.Ячейка dataobject)
        {
