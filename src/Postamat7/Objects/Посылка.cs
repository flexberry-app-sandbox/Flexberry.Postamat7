...
namespace IIS.Postamat7
{
    ...
    public class Посылка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat7.Транзакция fТранзакция;
        
        private IIS.Postamat7.Логистика fЛогистика;
        
        private IIS.Postamat7.Хранение fХранение;
        ...
        [PropertyStorage(new string[] {
                "Логистика"})]
        [NotNull()]
        public virtual IIS.Postamat7.Логистика Логистика
        {
            get
            {
                ...
                IIS.Postamat7.Логистика result = this.fЛогистика;
        ...
        [PropertyStorage(new string[] {
                "Транзакция"})]
        [NotNull()]
        public virtual IIS.Postamat7.Транзакция Транзакция
        {
            get
            {
                ...
                IIS.Postamat7.Транзакция result = this.fТранзакция;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat7.Хранение.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Хранение"})]
        public virtual IIS.Postamat7.Хранение Хранение
        {
            get
            {
                ...
                IIS.Postamat7.Хранение result = this.fХранение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосылкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаE", typeof(IIS.Postamat7.Посылка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПосылка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat7.DetailArrayOfПосылка members)

        // *** End programmer edit section *** (IIS.Postamat7.DetailArrayOfПосылка members)
        ...
        /// </summary>
        public DetailArrayOfПосылка(IIS.Postamat7.Хранение fХранение) : 
                base(typeof(Посылка), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Postamat7.Посылка this[int index]
        {
            get
            {
                return ((IIS.Postamat7.Посылка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat7.Посылка dataobject)
        {
